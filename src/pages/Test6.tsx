// TEST PAGE 6: Section overflow-x-clip with full width
// Approach: Let section handle overflow, image full width
...
function Test6() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <motion.section
        className={cn(
          "relative w-full overflow-x-clip overflow-y-visible bg-background text-foreground pt-40 sm:pt-48 md:pt-0 md:overflow-hidden"
        )}
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        {/* Image slider - full width with section overflow control */}
        <div className="relative w-full min-h-[300px] left-0 right-0 md:absolute md:top-0 md:right-0 md:left-auto md:w-1/2 md:h-[700px] lg:w-2/5 overflow-hidden">
      ...
      <div className="py-20 text-center">
        ...
        <p className="text-lg text-muted-foreground">Section overflow-x-clip, full width image</p>
      </div>
