// TEST PAGE 5: Absolute left 0 right 0 positioning
// Approach: Position absolute with left and right 0
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        {/* Image slider - absolute left 0 right 0 */}
        <div className="absolute left-0 right-0 min-h-[300px] md:top-0 md:right-0 md:left-auto md:w-1/2 md:h-[700px] lg:w-2/5 overflow-hidden">
      ...
      <div className="py-20 text-center">
        ...
        <p className="text-lg text-muted-foreground">Absolute positioning left-0 right-0</p>
      </div>
