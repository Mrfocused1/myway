// TEST PAGE 7: Grid + Negative Margin on Container
// Based on Test 3 spacing, moves entire grid up with negative margin
...
function Test7() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section - Grid + Negative Margin */}
      <motion.section
        className={cn(
      ...
      >
        {/* Grid Container with NEGATIVE MARGIN to move up */}
        <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] md:grid-rows-[auto_1fr_auto] gap-4 p-8 md:w-1/2 md:p-12 md:-mt-[180px] lg:w-3/5 lg:p-16 lg:-mt-[200px]">
          {/* Logo */}
      ...
      <div className="py-20 text-center">
        <h2 className="text-3xl font-bold mb-4">Test Page 7</h2>
        <p className="text-lg text-muted-foreground">Grid + Negative margin on container (-mt-[180px])</p>
      </div>
