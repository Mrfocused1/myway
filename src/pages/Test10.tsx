// TEST PAGE 10: Grid + Combo (Reduced Padding + Negative Margin)
// Based on Test 3 spacing, combines reduced padding with negative margin
...
function Test10() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section - Grid + Combo Approach */}
      <motion.section
        className={cn(
          "relative w-full overflow-hidden bg-background text-foreground pt-40 sm:pt-48 md:pt-[120px] lg:pt-[140px]"
        )}
        initial="hidden"
        animate="visible"
        variants={containerVariants}
      >
        {/* Grid Container with COMBO (reduced section padding + negative margin) */}
        <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] md:grid-rows-[auto_1fr_auto] gap-4 p-8 md:w-1/2 md:p-12 md:-mt-[100px] lg:w-3/5 lg:p-16 lg:-mt-[120px]">
          {/* Logo */}
      ...
      <div className="py-20 text-center">
        <h2 className="text-3xl font-bold mb-4">Test Page 10</h2>
        <p className="text-lg text-muted-foreground">Grid + Combo (reduced padding pt-[120px] + negative margin -mt-[100px])</p>
      </div>
