// TEST PAGE 2: Use width: 100vw on mobile
// Approach: Set image container to viewport width on mobile
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        {/* Image slider - use 100vw on mobile */}
        <div className="relative w-screen md:w-full min-h-[300px] md:absolute md:top-0 md:right-0 md:w-1/2 md:h-[700px] lg:w-2/5 overflow-hidden">
      ...
      <div className="py-20 text-center">
        ...
        <p className="text-lg text-muted-foreground">Image container width: 100vw on mobile</p>
      </div>
