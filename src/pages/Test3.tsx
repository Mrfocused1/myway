// TEST PAGE 3: Left -8, right 0 margin
// Approach: Only negative margin on left side
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        {/* Image slider - negative left margin only */}
        <div className="relative w-full min-h-[300px] -ml-8 mr-0 md:ml-0 md:mr-0 md:absolute md:top-0 md:right-0 md:w-1/2 md:h-[700px] lg:w-2/5 overflow-hidden">
      ...
      <div className="py-20 text-center">
        ...
        <p className="text-lg text-muted-foreground">Only left negative margin (-ml-8 mr-0)</p>
      </div>
