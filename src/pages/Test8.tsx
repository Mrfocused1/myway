// TEST PAGE 8: Grid + Reduced Top Padding
// Based on Test 3 spacing, reduces section padding to move content up
...
function Test8() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section - Grid + Reduced Padding */}
      <motion.section
        className={cn(
          "relative w-full overflow-hidden bg-background text-foreground pt-40 sm:pt-48 md:pt-[100px] lg:pt-[120px]"
        )}
        initial="hidden"
        animate="visible"
      ...
      <div className="py-20 text-center">
        <h2 className="text-3xl font-bold mb-4">Test Page 8</h2>
        <p className="text-lg text-muted-foreground">Grid + Reduced section padding (pt-[100px])</p>
      </div>
