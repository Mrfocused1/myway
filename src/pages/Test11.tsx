// TEST PAGE 11: Grid + Absolute Positioning of Grid Container
// Based on Test 3 spacing, absolutely positions entire grid
...
function Test11() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section - Grid + Absolute Container */}
      <motion.section
        className={cn(
          "relative w-full overflow-hidden bg-background text-foreground pt-40 sm:pt-48 md:pt-56 lg:pt-64 md:min-h-[700px]"
        )}
        initial="hidden"
        animate="visible"
        variants={containerVariants}
      >
        {/* Grid Container with ABSOLUTE POSITIONING */}
        <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] md:grid-rows-[auto_1fr_auto] gap-4 p-8 md:absolute md:top-12 md:left-12 md:w-1/2 md:p-0 lg:w-3/5 lg:top-16 lg:left-16">
          {/* Logo */}
      ...
      <div className="py-20 text-center">
        <h2 className="text-3xl font-bold mb-4">Test Page 11</h2>
        <p className="text-lg text-muted-foreground">Grid + Absolute positioning of entire grid container (top-12 left-12)</p>
      </div>
