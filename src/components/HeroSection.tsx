            ...
            <div className="md:contents">
                ...
                <div className="px-8 md:px-0 md:flex md:items-center md:px-12 lg:px-16">
                    <motion.main variants={containerVariants}>
                        ...
                        <motion.div className="my-6 h-1 w-20 bg-earthy-green" variants={itemVariants}></motion.div>
                        <motion.p className="mb-8 max-w-md text-base text-black hidden md:block" variants={itemVariants}>
                            {subtitle}
                        </motion.p>
                        <motion.a href={callToAction.href} className="text-lg font-bold tracking-widest text-earthy-green transition-colors hover:text-earthy-green-dark" variants={itemVariants}>
                            {callToAction.text}
                        </motion.a>
                    </motion.main>
                </div>
