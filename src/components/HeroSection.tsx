...
const HeroSection = React.forwardRef<HTMLDivElement, HeroSectionProps>(
  ({ className, logo, title, subtitle, callToAction, backgroundImages, scrollingText }, ref) => {
    ...
    return (
      ...
      >
        {/* Left Side: Content */}
        <div className="flex w-full flex-col justify-between p-8 md:w-1/2 md:p-12 md:pt-[63px] lg:w-3/5 lg:p-16 lg:pt-[79px] relative">
            {/* Logo - Absolutely positioned */}
            {logo && (
                <motion.div className="md:absolute md:top-0 md:left-8 lg:left-16" variants={itemVariants}>
